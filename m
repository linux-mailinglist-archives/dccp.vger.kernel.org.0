...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9ECEC59C5CA
	for <lists+dccp@lfdr.de>; Mon, 22 Aug 2022 20:11:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236709AbiHVSLC (ORCPT <rfc822;lists+dccp@lfdr.de>);
        Mon, 22 Aug 2022 14:11:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32826 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236447AbiHVSLB (ORCPT <rfc822;dccp@vger.kernel.org>);
        Mon, 22 Aug 2022 14:11:01 -0400
Received: from 66-220-155-178.mail-mxout.facebook.com (66-220-155-178.mail-mxout.facebook.com [66.220.155.178])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9536846214
        for <dccp@vger.kernel.org>; Mon, 22 Aug 2022 11:10:58 -0700 (PDT)
Received: by devbig010.atn6.facebook.com (Postfix, from userid 115148)
        id D749A10CCCA36; Mon, 22 Aug 2022 11:10:45 -0700 (PDT)
...
Subject: [PATCH RESEND net-next v4 1/3] net: Add a bhash2 table hashed by port and address
Date:   Mon, 22 Aug 2022 11:10:21 -0700
Message-Id: <20220822181023.3979645-2-joannelkoong@gmail.com>
...
@@ -182,14 +211,61 @@ inet_bind_bucket_create(struct kmem_cache *cachep, =
struct net *net,
...
-	__be32 daddr, nexthop;
 	...
 	struct rtable *rt;
 	int err;
@@ -89,9 +90,29 @@ int dccp_v4_connect(struct sock *sk, struct sockaddr *=
uaddr, int addr_len)
...
--- a/net/dccp/ipv6.c
+++ b/net/dccp/ipv6.c
@@ -934,8 +934,26 @@ static int dccp_v6_connect(struct sock *sk, struct s=
ockaddr *uaddr,
 	}
=20
 	if (saddr =3D=3D NULL) {
...
+								     sk, sock_net(sk),
+								     inet->inet_num);
+			prev_v6_rcv_saddr =3D sk->sk_v6_rcv_saddr;
+		}
+
 		saddr =3D &fl6.saddr;
...
+	struct inet_bind2_bucket *tb2;
 	...
 	int l3mdev;
@@ -239,11 +332,20 @@ inet_csk_find_open_port(struct sock *sk, struct ine=
...
+				spin_unlock(&head2->lock);
 		...
 		tb =3D NULL;
@@ -272,6 +374,8 @@ inet_csk_find_open_port(struct sock *sk, struct inet_=
...
=20
@@ -368,53 +472,95 @@ int inet_csk_get_port(struct sock *sk, unsigned sho=
rt snum)
...
@@ -962,6 +1108,7 @@ struct sock *inet_csk_clone_lock(const struct sock *=
sk,
=20
...
+	spin_lock(&head2->lock);
+	if (inet_csk(sk)->icsk_bind2_hash) {
+		struct inet_bind2_bucket *tb2 =3D inet_csk(sk)->icsk_bind2_hash;
+
...
=20
@@ -135,12 +212,21 @@ int __inet_inherit_port(const struct sock *sk, stru=
ct sock *child)
...
@@ -694,11 +910,13 @@ int __inet_hash_connect(struct inet_timewait_death_=
row *death_row,
...
+	bool tb_created =3D false;
 	...
 	int ret, i, low, high;
 	int l3mdev;
@@ -755,8 +973,7 @@ int __inet_hash_connect(struct inet_timewait_death_ro=
w *death_row,
...
+			if (inet_bind_bucket_match(tb, net, port, l3mdev)) {
 				if (tb->fastreuse >=3D 0 ||
 					...
 					goto next_port;
@@ -774,6 +991,7 @@ int __inet_hash_connect(struct inet_timewait_death_ro=
w *death_row,
 			spin_unlock_bh(&head->lock);
 			return -ENOMEM;
 		}
+		tb_created =3D true;
 		...
 		goto ok;
@@ -789,6 +1007,20 @@ int __inet_hash_connect(struct inet_timewait_death_=
row *death_row,
...
@@ -798,7 +1030,10 @@ int __inet_hash_connect(struct inet_timewait_death_=
row *death_row,
...
@@ -810,6 +1045,13 @@ int __inet_hash_connect(struct inet_timewait_death_=
row *death_row,
...
index bbe218753662..6ec28968c1f5 100644
--- a/net/ipv4/tcp.c
+++ b/net/ipv4/tcp.c
@@ -4736,6 +4736,12 @@ void __init tcp_init(void)
...
=20
 	/* Size and allocate the main established and bind bucket
 	 * hash tables.
@@ -4759,7 +4765,7 @@ void __init tcp_init(void)
...
+					2 * sizeof(struct inet_bind_hashbucket),
 					...
 					0,
@@ -4768,9 +4774,12 @@ void __init tcp_init(void)
 					0,
 					64 * 1024);
...
@@ -199,11 +199,12 @@ static int tcp_v4_pre_connect(struct sock *sk, stru=
ct sockaddr *uaddr,
...
-	__be32 daddr, nexthop;
 	...
 	struct rtable *rt;
 	int err;
@@ -246,10 +247,28 @@ int tcp_v4_connect(struct sock *sk, struct sockaddr=
 *uaddr, int addr_len)
...
@@ -287,8 +287,25 @@ static int tcp_v6_connect(struct sock *sk, struct so=
ckaddr *uaddr,
 	}
=20
 	if (!saddr) {
